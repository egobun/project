        ...
        Begin
            ...
            Begin
                ...
                Begin
                    ...
                    If PinProperty = 'LENGTH'            Then SchPin.PinLength        := MmsToCoord(StrToInt(TxtFieldValue)) Else
                    ...
                    If PinProperty = 'LOCATION X'        Then Begin
                                                                  PinLocX := MmsToCoord(StrToInt(TxtFieldValue));//MilsToCoord(10 * StrToInt(TxtFieldValue));
                                                                  PinLocMapped := True;
                                                              End Else
                    If PinProperty = 'LOCATION Y'        Then Begin
                                                                  PinLocY := MmsToCoord(StrToInt(TxtFieldValue));//MilsToCoord(10 * StrToInt(TxtFieldValue));
                                                                  PinLocMapped := True;
                                                              End ;
                End;
            End;
