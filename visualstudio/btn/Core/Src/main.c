...
int main(void)
{
  ...
  osThreadStaticDef(BtnTask, StartBtnTask, osPriorityIdle, 0, 128, BtnTaskBuffer, &BtnTaskControlBlock);
  BtnTaskHandle = osThreadCreate(osThread(BtnTask), NULL);

  /* definition and creation of LedTask */
  osThreadStaticDef(LedTask, StartLedTask, osPriorityIdle, 0, 128, LedTaskBuffer, &LedTaskControlBlock);
